...
const WaterLevelMap = async () => {
  const rivers = await fetcher<River[]>({ baseURL: process.env.API_URL, url: "/rivers", params: { type: "tma" } });

  return (
    <>
      <div className="text-4xl text-center mb-8">Persebaran Pos Duga Air</div>
